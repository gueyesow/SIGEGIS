...
<div id="container">
	...
	<div id="content">
		...
		<div class="ui-widget-content"><button id="poidsElectoralRegions" class="theToolTip boutons" title="Afficher les poids des régions">Poids électoral des régions</button></div><br />
